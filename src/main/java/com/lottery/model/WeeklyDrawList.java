...
/**
 * Wrapper osztály a Drools egy speciális gyengeségének kezelésére, mivel nem kezeli rendesen az insert-elt
 * collection-öket. Ellenben ha egy wrapper osztály field-jén kell iterálnia, úgy tökéltesen működik.
 */
